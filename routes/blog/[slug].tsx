                    ...
                    <article className="w-full flex flex-col shadow my-4">
                        ...
                        <div className="bg-gray-50 flex flex-col justify-start p-6">
                            ...
                            <p href="#" className="text-sm pb-8">
                                By <a href="#" className="font-semibold hover:text-gray-800">Carlos S. Nah</a>, Published
                            ...
                            <div className={"markdown-body"} dangerouslySetInnerHTML={{__html: gfm.render(post.content)}}></div>
                        </div>
                    </article>
                </section>
            </div>
